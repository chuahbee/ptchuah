! function(e) {
    ...
    })), e(".background-image").length > 0 && e(".background-image").each((function() {
        var t = e(this).attr("data-vs-img");
        e(this).css({
            "background-image": "url(" + t + ")"
        })
    })), t = ".sidemenu-wrapper", a = ".sideMenuCls", n = "show", e(".sideMenuToggler").on("click", (function(a) {
        a.preventDefault(), e(t).addClass(n), e("body").addClass("overflow-hidden")
    })), e(t).on("click", (function(a) {
        a.stopPropagation(), e(t).removeClass(n), e("body").removeClass("overflow-hidden")
    })), e(t + " > div").on("click", (function(a) {
        a.stopPropagation(), e(t).addClass(n), e("body").addClass("overflow-hidden")
    })), e(a).on("click", (function(a) {
        a.preventDefault(), a.stopPropagation(), e(t).removeClass(n), e("body").removeClass("overflow-hidden")
    })), function(t, a, n, s) {
        e(a).on("click", (function(a) {
    ...
    }(".popup-search-box", ".searchBoxTggler", ".searchClose", "show"), e(".counter").counterUp({
        delay: 10,
        time: 1e3
    ...
    })), e("select").length > 0 && (e("select").niceSelect(), e("select").parent().addClass("select-box-area")), e(".dateTime-pick").datetimepicker({
        timepicker: !0,
        datepicker: !0,
        format: "y-m-d H:i",
        hours12: !1,
    ...
    })), e(".vs-rating-input").length > 0 && e(".vs-rating-input").each((function() {
        e(this).find("span").on("click", (function() {
            e(".vs-rating-input span").addClass("active"), e(this).nextAll("span").removeClass("active")
        }))
    })), e(s = ".onepage-nav, .main-menu, .vs-mobile-menu").length > 0 && e(s).each((function() {
    ...
    })), e(".vs-btn").length > 0 && e(".vs-btn").each((function() {
        e(this).contents().filter((function() {
            return 1 !== this.nodeType
        })).wrap('<span class="vs-btn-text"></span>'), e(this).find("i").wrap('<span class="vs-btn-icon" />');
        var t = e(this).html();
        e(this).html(""), e(this).prepend('<span class="vs-btn-shape"></span><span class="vs-btn-shape"></span><span class="vs-btn-shape"></span> <span class="vs-btn-shape"></span>' + t)
    ...
    }), e("#amount").val("$" + e("#slider-range").slider("values", 0) + " - $" + e("#slider-range").slider("values", 1)), new WOW({
        boxClass: "wow",
